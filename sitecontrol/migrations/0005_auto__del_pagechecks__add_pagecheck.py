...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PageCheck'
        db.create_table('sitecontrol_pagecheck', (
        ...
        db.send_create_signal('sitecontrol', ['PageCheck'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PageCheck'
        db.delete_table('sitecontrol_pagecheck')
