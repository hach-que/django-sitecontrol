...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GitSource.last_check'
        db.add_column('sitecontrol_gitsource', 'last_check',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 6, 12, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GitSource.last_check'
        db.delete_column('sitecontrol_gitsource', 'last_check')
